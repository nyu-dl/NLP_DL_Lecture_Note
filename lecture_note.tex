...
\begin{align}
    ...
    C(\TT) = -\frac{1}{N} \sum_{n=1}^N \log \left(\sum_{k=1}^K \II_{k=y^n}
        \mu_k\right),
\end{align}
where 
\begin{align}
...
\begin{align}
    ...
    C_{x,t}(\TT) = -\log\left(\sum_{k=1}^K \II_{k=y} \mu_{t,k}\right),
\end{align}
...
\begin{align}
    ...
    C_x(\TT) = -\sum_{t=1}^l \log\left(\sum_{k=1}^K \II_{k=y} \mu_{t,k}\right).
\end{align}
