...
%\subsection{Generating Sentences from Recurrent Neural Network Language Model}
%
%\alert{TBD}
...
\subsection{Approximate Decoding: Beamsearch}
...
\begin{figure}[t]
    ...
    \begin{minipage}{0.48\textwidth}
        \centering
        \includegraphics[width=0.98\columnwidth]{figures/searchspace_1sent.pdf}
    \end{minipage}
    ...
    \begin{minipage}{0.48\textwidth}
        ...
        (b)
    \end{minipage}
    \caption{(a) Search space depicted as a tree. (b) A red curve with an arrow
    shows one sentence from this larger search space.}
...
{\em search}? Yes, this whole procedure of finding a maximally-likely
translation is equivalent to searching through a search space, in this case a
tree, of all possible sentences for one sentence that has the highest
...
\begin{figure}[t]
    ...
    \begin{minipage}{0.48\textwidth}
        \centering
        \includegraphics[width=0.98\columnwidth]{figures/beamsearch_k3.pdf}
    \end{minipage}
    ...
    \begin{minipage}{0.48\textwidth}
        ...
        (b)
    \end{minipage}
    \caption{(a) Greedy search. (b) Beam search with the beam width set to $3$.}
