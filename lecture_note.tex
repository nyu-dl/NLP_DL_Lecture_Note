...
use of language 
%(\alert{TBD: some citation on baby's language learning}) 
and the
...
replacement of the full sentence probability.
...
\section{Semi-Supervised Learning for Natural Language Processing with
Pretrained Word Embeddings}

One of the by-products from these language models, both neural language model
and continuous bag-of-words model, is the input weight matrix, or a word
embedding matrix $\mE$ (see Eq.~\eqref{eq:word_emb}.)
