...
than $1$, the norm of $\vh_l$ will {\em explode}, i.e., $\|\vh_l\| \to
...
\subsubsection{Is $\tanh$ a Blessing?}
...
Do you see how similar it looks like Eq.~\eqref{eq:approx_h}? If the recurrent
...
\begin{align*}
    ...
    \left(\mQ \mS \mQ^{\top}\right),
\end{align*}
where we used the eigendecomposition of $\mU=\mQ \mS \mQ^{\top}$. This can be
re-written into
\begin{align*}
    \frac{\partial \vh_{t}}{\partial \underline{\vh}_{t}} \mU = 
...
\begin{align*}
    ...
    \underbrace{
        ...
        \frac{\partial \vh_{t'+1}}{\partial \vh_{t'+1}} 
    }_{(a)}
...
\subsubsection{Gated Recurrent Units Address Vanishing Gradient}
...
gates are {\em not} fixed but are adaptive with respect to the input. Why is
this so?
