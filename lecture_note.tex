...
underlying meaning of the word. We will discuss this further later.
...
This whole function is called a neural language model.  See Fig.~\ref{fig:nlm}
for the graphical illustration of neural language model.

\begin{figure}[ht]
    \centering
    \includegraphics[width=0.5\textwidth]{figures/nlm.pdf}
